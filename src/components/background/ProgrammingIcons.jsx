...
const ProgrammingIcons = () => {
  return (
      <div className="grid grid-cols-3 place-items-center">
        <Java className="fill-current text-green-darkest h-14 w-14"/>
        <Python className="fill-current text-green-darkest h-14 w-14"/>
        <React2 className="fill-current text-green-darkest h-14 w-14"/>
      </div>
  )
}
